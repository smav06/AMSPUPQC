        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li class="active"><a href="ADQueryAsset.php">Asset</a></li>
                                ...
                                <table  class="display table table-bordered table-striped tblCampusData" id="dynamic-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 250px">Asset Description</th>
                                            <th style="width: 150px">Type</th>
                                            <th style="width: 150px">Acquisition Type</th>
                                            <th style="width: 150px">Date Acquired</th>
                                    ...
                                    <?php  
                                        ...
                                        $sql = "SELECT ams_r_asset.A_ID, ams_r_asset.A_DESCRIPTION, ams_r_asset.A_DATE, ams_r_asset.A_STATUS, ams_r_asset.A_ACQUISITION_TYPE, ams_r_asset.A_AVAILABILITY, ams_r_asset_library.AL_NAME FROM ams_r_asset JOIN ams_r_asset_library ON ams_r_asset.AL_ID = ams_r_asset_library.AL_ID";
