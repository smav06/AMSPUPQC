            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="ADPar.php">Purchase Accountability Receipt</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="ADCampus.php">Property Accountability Receipt</li>
                    </ul>
                    <!--breadcrumbs end -->
                </div>
            </div>
                                ...
                                <table  class="display table table-bordered table-striped tblCampusData" id="dynamic-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 250px">PAR No.</th>
