            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="ADAssetCategory.php">Asset Category</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><strong>Asset Category</strong></li>
                    </ul>
                    <!--breadcrumbs end -->
                </div>
            </div>
                                ...
                                <table  class="display table table-bordered table-striped tblCampusData" id="dynamic-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 900px">Category</th>
                                    ...
                                    <?php  
                                        ...
                                        $sql = "SELECT * FROM ams_r_asset_category";
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form role="form" method="POST">
                                                            <div class="form-group">
                                                                ...
                                                                <input style="color: black;" type="text" onfocus="inputCcodeOnClick(<?php echo $id ?>)" onblur="inputCcodeOnLeave(<?php echo $id ?>)" class="form-control" id="inputCcode<?php echo $id ?>" value="<?php echo $cat; ?>"/>
                                                            </div>
...
<!--Core js-->
    ...
    <script type="text/javascript">
        ...
        function formValidation()
        {
            ...
            {
                var cat = document.getElementById('addcampuscode').value;
        ...
        function btnSubmitForUpOnClick(modId)
        {
            ...
            {
                var upCat = document.getElementById('inputCcode' + modId).value;
                var uniqueId = modId;
