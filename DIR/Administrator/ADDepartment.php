                            ...
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped tblCampusData" id="dynamic-table">
                                    ...
                                    <?php  
                                        ...
                                        $sql = "SELECT ams_r_office.O_ID, ams_r_office.O_CODE, ams_r_office.O_NAME, ams_r_office.C_ID, ams_r_campus.C_CODE FROM ams_r_office JOIN ams_r_campus ON ams_r_office.C_ID = ams_r_campus.C_ID";
                                                        ...
                                                        <form role="form" method="POST">
                                                            <div class="form-group">
                                                                ...
                                                                <select style="width: 275px; float: right; margin-top: -33px; color: black;" class="form-control m-bot15" id="selectCCode<?php echo $id ?>" onfocus="" onblur="" name="assignpassempid" style="color: black; padding-left: 10px;">
                                                                    ...
                                                                    <option value="<?php echo $cid; ?>" hidden selected><?php echo $ccode; ?></option>

                                                                    <?php  

                                                                    $sqlforemployee = "SELECT C_CODE, C_ID FROM ams_r_campus";

                                                                    $results = mysqli_query($connection, $sqlforemployee) or die("Bad Query: $sql");

                                                                    while($row = mysqli_fetch_assoc($results))
                                                                    {
                                                                        $campuscode = $row['C_CODE'];
                                                                        $campusid = $row['C_ID'];

                                                                    ?>

                                                                    <option value= "<?php echo $campusid ?>"> <?php echo "$campuscode"; ?> </option>
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST">
                    <div class="form-group">
                        <label><strong>Department Code</strong></label>
                        <label style="margin-left: 179px;"><strong>Campus Code</strong></label>
                        <input style="color: black; width: 275px" onfocus="addcampuscodeOnClick()" onblur="addcampuscodeOnLeave()" type="text" class="form-control" id="addcampuscode"/>
                        <select style="width: 275px; float: right; margin-top: -33px; color: black;" class="form-control m-bot15" id="deptcampuscode" onfocus="deptcampuscodeOnClick()" onblur="deptcampuscodeOnLeave()" name="assignpassempid" style="color: black; padding-left: 10px;">
...
<!--Core js-->
    ...
    <script type="text/javascript">
        ...
        {
            if (document.getElementById('inputDCode' + modId).value == "" || document.getElementById('inputDCode' + modId).value == "Empty Fields are not allowed.") 
            {
                document.getElementById('inputDCode' + modId).value = "Empty Fields are not allowed."
                document.getElementById('inputDCode' + modId).style.color = "red";
                document.getElementById('inputDCode' + modId).style.backgroundColor = "#ffffcc";
                document.getElementById('inputDCode' + modId).style.borderColor = "red";
            }

            if (document.getElementById('inputDName' + modId).value == "" || document.getElementById('inputDName' + modId).value == "Empty Fields are not allowed.") 
            {
                document.getElementById('inputDName' + modId).value = "Empty Fields are not allowed."
                document.getElementById('inputDName' + modId).style.color = "red";
                document.getElementById('inputDName' + modId).style.backgroundColor = "#ffffcc";
                document.getElementById('inputDName' + modId).style.borderColor = "red";
            }

            if (document.getElementById('inputDCode' + modId).value != "Empty Fields are not allowed." && document.getElementById('inputDName' + modId).value != "Empty Fields are not allowed.") 
            {
                var deptCode = document.getElementById('inputDCode' + modId).value;
                var deptName = document.getElementById('inputDName' + modId).value;
                var campusCode = document.getElementById('selectCCode' + modId).value;
