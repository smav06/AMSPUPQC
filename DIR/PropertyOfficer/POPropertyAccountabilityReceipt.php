                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped" id="dynamic-table">
                                    <thead>
                                        <tr>
                                            <th class="hidden">PAR ID</th>
                                            <th style="width: 140px;">PAR No.</th>
                                            <th style="">Accountable Person</th>
                                            <th style="">Department</th>
                                            <th style="width: 170px;">Issue / Assigned Date</th>
                                    ...
                                    <tbody> 
                                        ...
                                        <?php  
                                            ...
                                            while($row = mysqli_fetch_assoc($result))
                                            {
                                              ...
                                              $no = $row['PAR_NO'];
                                              $date = $row['PAR_DATE'];
                                              $named = $row['EP_FNAME'] . " " . $row['EP_MNAME'] . " " . $row['EP_LNAME'];    
                                        ...
                                        <tr class="gradeX">  
                                            ...
                                            <td>
                                                <a class="btn btn-success" style="margin: -5px;" href="POPARReports.php?receiveparid=<?php echo $id; ?>"><i class="fa fa-eye"></i></a>
