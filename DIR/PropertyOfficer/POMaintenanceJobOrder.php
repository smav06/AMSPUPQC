                ...
                <div class="leftside-navigation">
                    ...
                    <span>Maintenance</span>
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="POMaintenanceJobOrder.php">Job Order</a></li>
                            </ul>
                        </li>
                        <li>
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <a class="btn btn-success" id="assignbtn2">Create/Generate Job Order</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #8C1C1C; color: white">
                    ...
                    <h4 class="modal-title">Generate Job Order</h4>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#assignbtn2').click(function() {
                ...
                {
                    // alert('tago');
                    swal("Please select atleast one item/asset.", "To create/generate job order asset please select atleast one.", "warning");
                }
                else
                {
                    // alert('labas modal');
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#btnsend').click(function(e) {
                ...
                swal({
                        title: "Are you sure you want to generate job order?",
                        text: "",
                        type: "warning",
