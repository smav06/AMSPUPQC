                                ...
                                <table  class="display table table-bordered table-striped" id="dynamic-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 140px;">Request No.</th>
                                            <th style="">Purpose</th>
                                    ...
                                    <tbody> 
                                        ...
                                        <?php  
                                            ...
                                            $sql = "SELECT URS.URS_ID, URS.URS_NO, URS.URS_REQUEST_DATE, URS.URS_PURPOSE, O.O_NAME, URSTM.URSTM_STATUS_TO_MAIN FROM ams_t_user_request_summary AS URS INNER JOIN ams_t_user_request AS UR ON UR.URS_ID = URS.URS_ID INNER JOIN ams_t_user_request_status_to_main AS URSTM ON URSTM.URS_ID = URS.URS_ID INNER JOIN ams_r_employee_profile AS EP ON UR.EP_ID = EP.EP_ID INNER JOIN ams_r_office AS O ON EP.O_ID = O.O_ID GROUP BY URS.URS_ID";
                                            ...
                                            while($row = mysqli_fetch_assoc($result))
                                            {
                                              ...
                                              $statfrommain = $row['URSTM_STATUS_TO_MAIN'];
                                        ?>
