    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="padding: 0.5px; background-color: #757575;">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php  
                                ...
                                while ($row = mysqli_fetch_array($result)) 
                                {
                                  ...
                                  <input type="text" id="F_lname" class="form-control" style="color: black;" value="<?php echo $gender; ?>" disabled><br> <?php
                                }
                            ...
                            <?php  
                                ...
                                {
                                  $phone = $row['EP_MOBILE']; ?>
                                  <input type="text" id="F_lname" class="form-control" style="color: black;" value="<?php echo $phone; ?>" disabled><br> <?php
                                }
                            ...
                            <?php  
                                ...
                                {
                                  $email = $row['EP_EMAIL']; ?>
                                  <input type="text" id="F_lname" class="form-control" style="color: black;" value="<?php echo $email; ?>" disabled><br> <?php
                                }
